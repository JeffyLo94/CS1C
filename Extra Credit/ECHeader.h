...
namespace JeffreyLo
{
	...
	const int    AS_NUM 	= 0;
	const string AS_NAME	= "Extra Credit";
...
/******************************************************************************
 * FUNCTION FindNumWords
 * ----------------------------------------------------------------------------
 *		This function will output the number of words in the specified file
 ******************************************************************************/
int FindNumWords(ifstream& inFile,			// Input File stream
